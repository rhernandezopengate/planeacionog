...
namespace WebAppOpenGate.Controllers
{
    public class usuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Nombre,Email,Fecha,rol_Id")] usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Nombre,Email,Fecha,rol_Id")] usuario usuario)
        {
            if (ModelState.IsValid)
            {
